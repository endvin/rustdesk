...
const url = 'https://remotedesk.app/';
      ...
      enhancementsTiles.insert(
          ...
          SettingsTile.switchTile(
              ...
              title: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(translate('Keep RemoteDesk background service')),
        ...
        SettingsSection(
          ...
          tiles: [
            ...
            SettingsTile(
              ...
              onPressed: (context) =>
                  launchUrlString('https://remotedesk.app/privacy.html'),
...
void showAbout(OverlayDialogManager dialogManager) {
  dialogManager.show((setState, close, context) {
    return CustomAlertDialog(
      title: Text(translate('About RemoteDesk')),
